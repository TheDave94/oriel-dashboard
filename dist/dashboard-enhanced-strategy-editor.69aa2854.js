/*! For license information please see dashboard-enhanced-strategy-editor.69aa2854.js.LICENSE.txt */
    ...
    `:n.s6}_renderUsageSuggestion(){if(!this._hass)return n.qy``;if(!(0,ft.FN)())return n.qy``;if(this._config._usage_suggestion_dismissed)return n.qy``;const e=this._getSectionsOrder(),t=(0,ft.p1)(e);if(!t)return n.qy``;const i=(0,ft.Tn)();return n.qy`
      <div class="de-usage-banner">
        <div class="de-usage-title">
          ...
          <span class="de-usage-stats">(based on ${i} taps)</span>
        </div>
        ...
        <div class="de-usage-order">
          ${t.order.map((e,t)=>n.qy`<span class="de-usage-chip">${t+1}. ${e}</span>`)}
        </div>
      ...
      <div class="de-migration-banner">
        ...
        ${e.map(e=>n.qy`
            <div class="de-migration-row">
              <div>
                <div class="de-migration-label">${e.label}</div>
                <div class="de-migration-desc">${e.description}</div>
              </div>
              <button class="de-migration-apply" @click=${()=>this._applyMigration(e)}>
                Apply
              </button>
            </div>
          `)}
