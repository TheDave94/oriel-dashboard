...
Oriel funktioniert eigenständig und ist zugleich bewusst darauf ausgelegt, mit zwei
Multi-Quellen-Integrationen für Home Assistant zusammenzuarbeiten:

- **[PollenWatch](https://github.com/TheDave94/pollenwatch)** — eine Pollen-Integration,
  die Oriel **automatisch erkennt** und als First-Party-Pollenkarte samt Badges rendert,
  ohne manuelle Kartenkonfiguration.
- **[AirWatch](https://github.com/TheDave94/airwatch)** — eine Multi-Quellen-Luftqualitäts-Integration,
  die die Architektur von PollenWatch teilt. Oriel **erkennt sie automatisch** und rendert
  eine First-Party-Luftqualitätskarte — schlechtester Teilindex, Konsens pro Schadstoff,
  ein N-von-M-Quellen-Badge und explizite Abweichung — ohne manuelle Kartenkonfiguration.

## Lizenz

[MIT](LICENSE) © Oriel Dashboard Mitwirkende.
